...
public class CustomerRepositoryJdbcImpl implements CustomerRepository {
   ...
   @Autowired
	...
	public Long registerUser(Customer customer) {
		String sql = "INSERT INTO customer (User_Name,Pass,Email_Address,First_Name,Last_Name,Phone_Number) VALUES(:userName,:password,:emailAddress,:firstName,:lastName,:phoneNumber)";
