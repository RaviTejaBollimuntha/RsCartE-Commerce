...
--
-- Table structure for table `customeractivation`
--
...
--
-- Dumping data for table `customeractivation`
--

LOCK TABLES `customeractivation` WRITE;
/*!40000 ALTER TABLE `customeractivation` DISABLE KEYS */;
/*!40000 ALTER TABLE `customeractivation` ENABLE KEYS */;
UNLOCK TABLES;
