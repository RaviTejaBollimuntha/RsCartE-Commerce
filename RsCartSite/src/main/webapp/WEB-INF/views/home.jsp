						...
						<div class="item  col-xs-4 col-lg-4">
							<div class="thumbnail">
								...
								<div class="caption">
									...
									<p class="group inner list-group-item-text">The iPhone is a smartphone developed by Apple. ... 
									The iPhone has a sleek, minimalist design, and differs from other smartphones in its lack of buttons.
									 Most operations on the iPhone are performed using the touch screen display.</p>
									<div class="row">
