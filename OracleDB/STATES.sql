...
--------------------------------------------------------
  ...
  CREATE TABLE "STATES" ("ID" NUMBER(11,0), "NAME" VARCHAR2(30), "COUNTRY_ID" NUMBER(11,0))
...
Insert into STATES (ID,NAME,COUNTRY_ID) values (2712,'Ãstfold',164);
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C007321" ON "STATES" ("ID")
--------------------------------------------------------
--  Constraints for Table STATES
--------------------------------------------------------

  ALTER TABLE "STATES" MODIFY ("ID" NOT NULL ENABLE)
  ALTER TABLE "STATES" MODIFY ("NAME" NOT NULL ENABLE)
  ALTER TABLE "STATES" MODIFY ("COUNTRY_ID" NOT NULL ENABLE)
  ALTER TABLE "STATES" ADD PRIMARY KEY ("ID") ENABLE
